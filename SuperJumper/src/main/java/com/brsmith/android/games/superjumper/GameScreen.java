...
import com.brsmith.android.games.superjumper.World.WorldListener;
...
public class GameScreen extends GLScreen 
{
	...
	public GameScreen(IGame game)
	{
		...
		{
			@Override
			public void jump() { Assets.playSound(Assets.jumpSound); }
			
			@Override
			public void highJump() { Assets.playSound(Assets.highJumpSound); }
			
			@Override
			public void hit() { Assets.playSound(Assets.hitSound); }

			@Override
			public void coin() { Assets.playSound(Assets.coinSound); }
		};
	...
	private void updateRunning(float deltaTime)
	{
		...
		if(world.timer > 0)
		{
			world.timer -= deltaTime;
			timerString = "" + ((int)world.timer + 1);
		}
	...
	public void presentRunning()
	{
		...
		Assets.font.drawText(batcher, timerString, 16, 20);
	}
