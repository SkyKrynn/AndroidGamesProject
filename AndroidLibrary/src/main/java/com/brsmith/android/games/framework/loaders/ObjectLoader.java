package com.brsmith.android.games.framework.loaders;
    ...
    public static Vertices3 load(GLGame game, String file)
    {
        ...
        try
        {
            ...
            for(int idx = 0; idx < lines.size(); idx++)
            {
                ...
                {
                    String[] tokens = line.split("[ ]+");
                    normals[normalsIndex] = Float.parseFloat(tokens[1]);
                    normals[normalsIndex + 1] = Float.parseFloat(tokens[2]);
                    normals[normalsIndex + 2] = Float.parseFloat(tokens[3]);
                    normalsIndex += 3;
                    numNormals++;
                    continue;
                }
            ...
            for(int idx = 0, vi = 0; idx < numFaces * 3; idx++)
            {
                int vertexIdx = facesVerts[idx] * 3;
                ...
                if(numNormals > 0)
                {
                    int normalIdx = facesNormals[idx] * 3;
