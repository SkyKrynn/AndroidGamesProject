...
{
	static final int MAX_OBJECTS_IN_CELL = 10;
	...
	public SpatialHashGrid(float worldWidth, float worldHeight, float cellSize)
	{
		...
		{
			dynamicCells[i] = new ArrayList<GameObject>(MAX_OBJECTS_IN_CELL);
			staticCells[i] = new ArrayList<GameObject>(MAX_OBJECTS_IN_CELL);
		}
		foundObjects = new ArrayList<GameObject>(MAX_OBJECTS_IN_CELL);
	}
