...
public class ExternalStorageTest extends Activity
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		{
			textView.setText("No external media mounted");
		}
		else
		{
			File externalDir = Environment.getExternalStorageDirectory();
			File textFile = new File(externalDir.getAbsolutePath() + File.separator + "text.txt");
			// This was used to get traces file
			// File textFile = new File(File.separator + "data" + File.separator + "anr" + File.separator + "traces.txt");
			try
			{
